...
<section class="terno">
   ...
   <div class="row">
      ...
      <div class="terno-col">
          <img src="images/terno3.jfif" alt="">
         <h1>$10.0</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
   </div>
   ...
   <div class="row">
      <div class="terno-col">
          <img src="images/terno4.jpg" alt="">
         <h1>$10.0</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="terno-col">
          <img src="images/terno5.jpg" alt="">
         <h1>$10.0</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="terno-col">
         <img src="images/terno6.jfif" alt="">
         <h1>$10.0</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
   </div>
   ...
   <div class="row">
      <div class="terno-col">
          <img src="images/terno7.jpg" alt="">
         <h1>$10.0</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="terno-col">
          <img src="images/terno8.jpg" alt="">
         <h1>$10.0</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="terno-col">
          <img src="images/terno9.jfif" alt="">
         <h1>$10.0</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
   </div>
   ...
   <div class="row">
      <div class="terno-col">
          <img src="images/terno10.jpg" alt="">
         <h1>$10.0</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="terno-col">
      ...
      <div class="terno-col">
          <img src="images/terno12.jfif" alt="">
         <h1>$10.0</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
   </div>
