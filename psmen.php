...
<section class="psmen">
   ...
   <div class="row">
      ...
      <div class="psmen-col">
          <img src="images/polo5.jpg" alt="">
         <h1>$12.5</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="psmen-col">
         <img src="images/polo6.jpg" alt="">
         <h1>$7.7</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
   </div>
   ...
   <div class="row">
      <div class="psmen-col">
          <img src="images/polo7.jpg" alt="">
         <h1>$11.5</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="psmen-col">
          <img src="images/polo8.jpg" alt="">
         <h1>$12.5</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="psmen-col">
          <img src="images/polo9.jpg" alt="">
         <h1>$6.55</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
   </div>
   ...
   <div class="row">
      <div class="psmen-col">
          <img src="images/polo10.jpg" alt="">
         <h1>$10.4</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="psmen-col">
          <img src="images/polo11.jpg" alt="">
         <h1>$12.5</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="psmen-col">
          <img src="images/polo12.jpg" alt="">
         <h1>$8.3</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>>
      </div>
   </div>
