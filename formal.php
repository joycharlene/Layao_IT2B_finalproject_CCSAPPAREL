...
<section class="formal">
   ...
   <div class="row">
      <div class="formal-col">
         <img src="images/formal1.jpg" alt="">
         <h1>$20.5</h1>
      ...
      <div class="formal-col">
          <img src="images/formal3.jpg" alt="">
         <h1>$20.5</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
   </div>
   ...
   <div class="row">
      <div class="formal-col">
          <img src="images/formal4.jpg" alt="">
         <h1>$18.0</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="formal-col">
          <img src="images/formal5.jpg" alt="">
         <h1>$10.3</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="formal-col">
         <img src="images/formal6.jpg" alt="">
         <h1>$20.5</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
   </div>
   ...
   <div class="row">
      <div class="formal-col">
          <img src="images/formal7.jpg" alt="">
         <h1>$11.5</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="formal-col">
          <img src="images/formal8.jpg" alt="">
         <h1>$10.0</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="formal-col">
          <img src="images/formal9.jpg" alt="">
         <h1>$13.5</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
   </div>
   ...
   <div class="row">
      <div class="formal-col">
          <img src="images/formal10.jpg" alt="">
         <h1>$12.5</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="formal-col">
          <img src="images/formal11.jpg" alt="">
         <h1>$20.5</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
      <div class="formal-col">
          <img src="images/formal12.jpg" alt="">
         <h1>$22.5</h1>
         <a href="payment.php" class="btn">BUY NOW</a> <a href="contact.php" class="btn">Message</a>
      </div>
   </div>
